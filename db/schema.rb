...
ActiveRecord::Schema[7.0].define(version: 2025_07_08_000000) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bouncehouse_id"], name: "index_favorites_on_bouncehouse_id"
  ...
  add_foreign_key "bouncehouses", "users"
  add_foreign_key "calendars", "bouncehouses"
  add_foreign_key "favorites", "bouncehouses"
  add_foreign_key "favorites", "users"
  add_foreign_key "messages", "conversations"
  add_foreign_key "messages", "users"
  add_foreign_key "notifications", "users"
  add_foreign_key "photos", "bouncehouses"
  add_foreign_key "reservations", "bouncehouses"
  add_foreign_key "reservations", "users"
  add_foreign_key "reviews", "bouncehouses"
